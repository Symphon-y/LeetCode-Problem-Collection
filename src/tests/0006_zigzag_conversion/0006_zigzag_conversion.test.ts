...
test('If the input string is PAYPALISHIRING with 11 rows the answer should be PAYPALISGHNIIR', () => {
  return expect(convert('PAYPALISHIRING', 11)).toEqual('PAYPALISGHNIIR');
});
